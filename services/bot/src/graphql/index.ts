...
export const ToolParts = gql`
  ...
  featured
    ...
    `;
export const GroupToolConfigParts = gql`
  ...
  rolesAllowed
    ...
    ${ToolParts}`;
export const GroupResourceParts = gql`
    fragment GroupResourceParts on GroupResource {
  id
  groupID
  title
  link
    ...
    `;
export const ReactionRoleParts = gql`
    fragment ReactionRoleParts on ReactionRole {
  id
  emoji
  roleID
}
    `;
export const KeywordPingerEntryParts = gql`
    fragment KeywordPingerEntryParts on KeywordPingerEntry {
  id
  groupID
  keywordSet
  channels
  pingRoles
    ...
    `;
export const LoyaltyLeaderParts = gql`
    fragment LoyaltyLeaderParts on LoyaltyLeader {
  memberID
  points
}
    `;
export const LoyaltyAutoAddConfigParts = gql`
    fragment LoyaltyAutoAddConfigParts on LoyaltyAutoAddConfig {
  id
  groupID
  channelID
  amount
    ...
    `;
export const LoyaltyPrizeParts = gql`
    fragment LoyaltyPrizeParts on LoyaltyPrize {
  id
  groupID
  name
  cost
    ...
    `;
export const LoyaltyReactionConfigParts = gql`
    fragment LoyaltyReactionConfigParts on LoyaltyReactionConfig {
  id
  groupID
  emoji
  amount
...
export const GroupParts = gql`
  ...
  keywordPingerEntries {
    ...KeywordPingerEntryParts
  }
  loyaltyLeaderboard {
    ...LoyaltyLeaderParts
  }
  loyaltyAutoAddConfigs {
    ...LoyaltyAutoAddConfigParts
  }
  loyaltyPrizes {
    ...LoyaltyPrizeParts
  }
  loyaltyReactionConfigs {
    ...LoyaltyReactionConfigParts
  }
  botPlanID
  fnf
  botStatus
  ...
  twitterAccessSecret
  successChannels
  sendFollowUpSuccessMessage
  allowSuccessDelete
  successMessageFormat
  twilioConnectAccountSID
  twilioNotifyServiceSID
  smsSendRoles
...
${LoyaltyPrizeParts}
${LoyaltyReactionConfigParts}`;
export const GroupMemberParts = gql`
  ...
  lifetimeLoyaltyPoints
    ...
    ${GroupParts}`;
export const LoyaltyPrizeClaimParts = gql`
    fragment LoyaltyPrizeClaimParts on LoyaltyPrizeClaim {
  id
  groupID
  memberID
  member {
  ...
  fulfilled
    ...
    ${GroupMemberParts}
${LoyaltyPrizeParts}`;
export const SuccessTweetParts = gql`
    fragment SuccessTweetParts on SuccessTweet {
  id
  groupID
  memberID
  imageUrl
...
export const TicketParts = gql`
  ...
  channelID
    ...
    `;
export const CreateLoyaltyPrizeClaimDocument = gql`
    mutation CreateLoyaltyPrizeClaim($memberID: String!, $prizeID: Float!) {
  createLoyaltyPrizeClaim(memberID: $memberID, prizeID: $prizeID) {
    ...LoyaltyPrizeClaimParts
  }
}
    ${LoyaltyPrizeClaimParts}`;
export const CreateScheduledTaskDocument = gql`
    mutation CreateScheduledTask($event: TaskEvent!, $data: JSONObject!, $date: DateTime!) {
  createScheduledTask(event: $event, data: $data, date: $date)
}
    `;
export const CreateTicketDocument = gql`
    mutation CreateTicket($type: TicketType!, $memberID: String!, $channelID: String!) {
  createTicket(type: $type, memberID: $memberID, channelID: $channelID) {
    ...TicketParts
  }
}
    ${TicketParts}`;
export const DeleteSuccessTweetDocument = gql`
    mutation DeleteSuccessTweet($messageID: String, $followUpMessageID: String) {
  deleteSuccessTweet(messageID: $messageID, followUpMessageID: $followUpMessageID) {
    ...SuccessTweetParts
  }
}
    ${SuccessTweetParts}`;
export const SeedToolsDocument = gql`
    mutation SeedTools($tools: [ToolOptions!]!) {
  seedTools(tools: $tools) {
    ...ToolParts
  }
}
    ${ToolParts}`;
export const SendSmsMessageDocument = gql`
    mutation SendSmsMessage($message: String!) {
  sendSmsMessage(message: $message)
}
    `;
export const UpdateLoyaltyPointsDocument = gql`
    mutation UpdateLoyaltyPoints($memberID: String!, $pointDifference: Float!) {
  updateLoyaltyPoints(memberID: $memberID, pointDifference: $pointDifference) {
    ...GroupMemberParts
  }
}
    ${GroupMemberParts}`;
export const UpdateSmsNumberDocument = gql`
    mutation UpdateSmsNumber($memberID: String!, $smsNumber: String) {
  updateSmsNumber(memberID: $memberID, smsNumber: $smsNumber) {
    ...GroupMemberParts
  }
}
    ${GroupMemberParts}`;
export const UpdateSuccessTweetDocument = gql`
    mutation UpdateSuccessTweet($id: Float!, $followUpMessageID: String!) {
  updateSuccessTweet(id: $id, followUpMessageID: $followUpMessageID) {
    ...SuccessTweetParts
  }
}
    ${SuccessTweetParts}`;
export const UploadSuccessTweetDocument = gql`
    mutation UploadSuccessTweet($imageUrl: String!, $memberID: String!, $channelID: String!, $messageID: String!) {
  uploadSuccessTweet(imageUrl: $imageUrl, memberID: $memberID, channelID: $channelID, messageID: $messageID) {
    ...SuccessTweetParts
  }
}
    ${SuccessTweetParts}`;
export const GroupDocument = gql`
  ...
  group {
    ...
    ${GroupParts}`;
export const GroupMemberDocument = gql`
    query GroupMember($memberID: String!) {
  groupMember(memberID: $memberID) {
    ...GroupMemberParts
  }
}
    ${GroupMemberParts}`;
export const InstanceFromOrdinalDocument = gql`
    query InstanceFromOrdinal {
  instanceFromOrdinal(podOrdinal: 1) {
    groupToken
    botToken
  }
}
    `;
export const MainBotGroupTokensDocument = gql`
    query MainBotGroupTokens {
  mainBotGroupTokens
}
    `;
export const ProxiesDocument = gql`
    query Proxies {
  proxies {
    id
    proxy
